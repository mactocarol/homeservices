...
<input class="string optional" id="booking_user_attributes_first_name" maxlength="128" name="fname" size="50" type="text">
</div>
<div class="col-md-6 col-sm-6 col-xs-6">
<label for="booking_user_attributes_last_name">Last Name</label>
<input class="string optional inspectletIgnore" id="booking_user_attributes_last_name" maxlength="128" name="lname" size="50" type="text">
</div>
</div>
...
<input class="string required inspectletIgnore placeholder" id="booking_address_attributes_address1" maxlength="255" name="address" placeholder="" size="50" autocomplete="off" type="text">
</div>
<div class="col-md-6 col-sm-6 col-xs-6">
<label for="booking_address_attributes_address2">Flat <span class="hide-small"> (optional)</span>
</label><input class="string optional inspectletIgnore" id="booking_address_attributes_address2" maxlength="128" name="flat_add" size="50" type="text">
</div>
</div>
...
<input class="string required" id="booking_address_attributes_city" maxlength="128" name="city" size="50" value="<?php echo $country_city->city; ?>" type="text">
</div>
<div class="col-md-6 col-sm-6 col-xs-6">
<label for="booking_address_attributes_state">County</label>
<input class="string required" id="booking_address_attributes_state" maxlength="30" name="country" value="<?php echo $country_city->country; ?>" size="30" value="" type="text">
</div>
</div>
<div class="col-md-12 col-sm-12 col-xs-12">
<div class="col-md-6 col-sm-6 col-xs-6">
...
<input class="full_phone optional full-phone-field js-limit-input js-phone-input inspectletIgnore" id="booking_user_attributes_phone" maxlength="14" name="phonenumber" size="14" type="tel">
...
<div class="center smaller">By clicking the button below, I accept Handy's <a href="terms.php" target="_blank">Terms of Use</a></div>
...
<?php 
// for cat attribute.....
// $cat_price = json_decode($cat_record->cat_attribute);
// $small_item_unit = $cat_price[0]->professionals;
// $small_item_hr = $cat_price[0]->hours;
// $small_item_price = $cat_price[0]->price;
// $medium_item_unit = $cat_price[1]->professionals;
// $medium_item_hr = $cat_price[1]->hours;
// $medium_item_price = $cat_price[1]->price;
// $large_item_unit = $cat_price[2]->professionals;
// $large_item_hr = $cat_price[2]->hours;
// $large_item_price = $cat_price[2]->price;
// // for choosed plan...
//  $first_item = $record->first_item;
//  $second_item = $record->second_item;
//  $thired_item = $record->thired_item;
//  $book_date = $record->select_date;
//  $book_time = $record->select_time;
//  // for hr....
//  $smallunit = $small_item_hr * $first_item;
//  $mediumunit = $small_item_hr * $second_item;
//  $largeunit = $small_item_hr * $thired_item;
//  // for price...
//  $smallprice = $small_item_price * $first_item;
//  $mediumprice = $medium_item_price * $first_item;
//  $largeprice = $large_item_price * $first_item;
//$total_hr = $smallunit + $mediumunit + $largeunit;
//$total_price = $smallprice + $mediumprice + $largeprice;

?>
<div class="payment-info-content info-sidebar-text">
<strong class="payment-service-name">Moving Help</strong>
<a href="<?php echo base_url().'GeneralBooking'; ?>" data-method="post" rel="nofollow" style="padding-left: 10px">edit</a>
...
<p>
<?php //echo $book_date; ?>&nbsp;
<span class="nowrap"><?php //echo $book_time; ?></span>
</p>
</div>
</div>
<div class="checkout-row info-row">
...
<span class="js-job-hours"><?php //echo $total_hr; ?></span>
hours
</p></div>
</div>
...
<div class="payment-summary-amount">$<?php //echo $total_price; ?> </div>
</div>
...
<div class="total-price">$<span class="js-total-price" style="display: inline;"><?php //echo $total_price; ?></span><span class="price-suffix"></span></div>
</div>
</div>
</div>
</div>
