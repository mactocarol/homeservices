                                    ...
                                    <div class="checkout-row stepper">
                                        <div class="columns">
                                            <div class="numbers-row">
                                                ...
                                                <span class="show_room"><input type='text' name='qty' id='qty' value="1"/><span><?php echo $get_field[0]->professionals; ?></span></span>
                                    ...
                                    <div class="checkout-row stepper">
                                        ...
                                        <div class="columns">
                                            <div class="numbers-row">
                                                ...
                                                <span class="show_room"><input type='text' name='mediumqty' id='mediumqty' value="1"/><span><?php echo $get_field[1]->professionals; ?></span></span>
                                                    ...
                                                    <div class="checkout-row">
                                                        <div class="column" id="hourly_div" style="display: none">
                                                            ...
                                                            <div class="select-wrapper form-select-wrapper" id="hour_price" >
                                                                ...
                                                                <span class="perror" id="hourlyerror" style="display: none;">This Field is required</span>
                                    ...
                                    <div class="form-line">
                                        <div class="checkout-row">
                                            <div class="column" id="helpers_div" style="display: none">
                                                ...
                                                <div class="select-wrapper form-select-wrapper">
                                                    <select class="hb_select disabled" id="helpers" name="helpers" disabled="true">
                                                        <option >Please Select </option>
                                                        <?php
...
<!--                                <div class="checkout-row push-top">
                                ...
                                <div class="checkout-row push-top">
                                        <div class="columns">
                                            <textarea class="placeholder" cols="40" id="booking_params_notes" name="job_desc" placeholder="Please describe the job in detail. (optional)" rows="3"></textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="checkout-row">
                                ...
                                <div class="checkout-row">
                                    <div class="columns " style="position: relative;display: inline-block;width: 100%;">										
                                        <input class="pikaday when-font" id="datepicker" data-format="MM/DD/YYYY" name="on_date" type="text" >
										<i class="glyphicon glyphicon-calendar cal_c"></i>
                                ...
                                <div class="checkout-row push-top">
                                    <div class="columns">
                                        <input class="form-input when-font inspectletIgnore placeholder"  
                                               name="emailid" placeholder="Email Address" id="emailid" size="30" type="email">
                                ...
                                <div class="when-continue-button-container checkout-row">
                                    <div class="columns">
                                        <button class="booking-continue-button btn-continue when-button btn-primary js-submit-payment" type="submit" id="getPrice"  >Get a Price</button>
                                    </div>
                                </div>
                        </form>
                    </div>
