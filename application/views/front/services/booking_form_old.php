										...
										<div class="media1">										  
										   ...
										   <p><b><em>*If you are looking custom plan then please contact us!*</em></b></p>
											  <div class="form-group" style="padding:12px;">
												 <textarea class="form-control animated" placeholder="Share your plan with Home Services team..."></textarea>
												 <button class="btn btn-info pull-right" style="margin-top:10px" type="button">Submit</button>
											  </div>
										   </div>
										</div>
									 </div>
    ...
    <?php } ?>
                                ...
                                <div class="minimum_plans  price_btns_deatis" id="minimum_plans">
                                    ...
                                    if ($get_fetch_data->cat_attribute != '') {
                                        ...
                                        $monthlys = 1;
                                        ?>
                                        <input type="hidden" name="getweek" id="getweek" value="<?php echo $getweek; ?>">
                                        <input type="hidden" name="getbiweek" id="getbiweek" value="<?php echo $getbiweek ?>">
            ...
            <?php echo $weekthree_final_price; ?>
                                                        </span>
                                                        <input type="hidden" name="bi_three_mnth" id="bi_three_mnth" value="<?php echo $bithree_final_price; ?>">
                                                        <input type="hidden" name="week_three_mnth" id="week_three_mnth" value="<?php echo $weekthree_final_price; ?>">
            ...
            <?php echo $weeksix_final_price; ?>
                                                        </span>
                                                        <input type="hidden" name="bi_six_mnth" id="bi_six_mnth" value="<?php echo $bisix_final_price; ?>">
                                                        <input type="hidden" name="week_six_mnth" id="week_six_mnth" value="<?php echo $weeksix_final_price; ?>">
            ...
            <?php echo $weektwelve_final_price; ?>
                                                        </span>
                                                        <input type="hidden" name="bi_twelve_mnth" id="bi_twelve_mnth" value="<?php echo $bitwelve_final_price; ?>">
                                                        <input type="hidden" name="week_twelve_mnth" id="week_twelve_mnth" value="<?php echo $weektwelve_final_price; ?>">
