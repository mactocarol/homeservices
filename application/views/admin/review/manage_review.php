    ...
    <div class="row">
        <div class="col-sm-12">
            <section class="panel">
              ...
              Review List
              <span class="tools pull-right"> <a href="<?php echo base_url();?>AddReview"><i class="fa fa-plus-circle"></i> Add Review</a></span>
                                    ...
                                    if ($review != '') {
                                        foreach ($review as $user) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo ucfirst($user->user_id); ?></td>
                                                <td><?php echo ucfirst($user->rating); ?></td>
                                                <td><?php echo ucfirst($user->comment); ?></td>
                                                ...
                                                <td><?php if($user->status == 1){ echo '<span class="label label-primary">Active</span>'; }else{ echo '<span class="label label-info">Inactive</span>'; } ?></td>
                                                   <td>
                                                    <a href="<?php echo base_url(); ?>EditReviewDetails/<?php echo $user->id; ?>" title="Edit details"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
                                                    <a href="<?php echo base_url(); ?>DeleteReview/<?php echo $user->id; ?>" title="Delete"><i class="fa fa-trash-o"></i></a>
