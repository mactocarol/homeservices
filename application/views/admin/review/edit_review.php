    ...
    <div class="row">
        <div class="col-lg-12">
            <section class="panel">
                ...
                $name = $review_details->full_name;
                $userid = $review_details->user_id;
                $rating = $review_details->rating;
                $comment = $review_details->comment;
                ...
                <div class="panel-body"> <span style="color:red"><?php echo validation_errors(); ?> <?php echo $this->session->flashdata('Register_error'); ?></span>
                    <form role="form" class="form-horizontal" action="" method="POST" enctype="multipart/form-data"  name="myForm" id="myForm">
                        ...
                        <div class="form-group" id="category_section" style="<?php //echo $category_display; ?>">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="full_name" id="banner_title" value="<?php echo $name; ?>"class="form-control required">
                            </div>
                        </div>
                         <div class="form-group" id="category_section" style="<?php //echo $category_display; ?>">
                            <label class="control-label col-sm-4">User-Id<?php echo ASTRIK; ?></label>
                            <div class="col-sm-7">
                                <input type="text" name="user_id" id="banner_title" value="<?php echo $userid; ?>"class="form-control required">
                            </div>
                        </div>
                         <div class="form-group" id="category_section" style="<?php //echo $category_display; ?>">
                            <label class="control-label col-sm-4">Rating<?php echo ASTRIK; ?></label>
                            <div class="col-sm-7">
                                <input type="text" name="rating" id="banner_title" value="<?php echo $rating; ?>"class="form-control required">
                            </div>
                        </div>
                         <div class="form-group" id="category_section" style="<?php //echo $category_display; ?>">
                            <label class="control-label col-sm-4">Comment<?php echo ASTRIK; ?></label>
                            <div class="col-sm-7">
                                <input type="text" name="comment" id="banner_title" value="<?php echo $comment; ?>"class="form-control required">
                            </div>
                        </div>
<!--                         <div class="form-group" id="category_section" style="<?php //echo $category_display; ?>">
