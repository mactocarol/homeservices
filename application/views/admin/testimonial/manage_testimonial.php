    ...
    <div class="row">
        <div class="col-sm-12">
            <section class="panel">
              ...
              Testimonial List
              <span class="tools pull-right"> <a href="<?php echo base_url();?>AddTestimonial"><i class="fa fa-plus-circle"></i> Add Testimonial</a></span>
                            ...
                            <table class="display table table-bordered table-striped" id="dynamic-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Author Image</th>
                                        <th>Author Share Message</th>
                                        <th>Author Share Date</th>
                                        <th>Status</th>
                                  ...
                                  <tbody>
                                    ...
                                    $cnt = 1;
                                    if ($testimonial != '') {
                                        foreach ($testimonial as $user) {
                                            ?>
                                            <tr>
                                                <td><?php echo $cnt; ?></td>
                                                <td><?php echo ucfirst($user->author_name); ?></td>
                                                <td><?php echo ucfirst($user->author_email); ?></td>
                                                   <td><img src="<?php echo MEDIAURL;?>testimonial/<?php echo $user->author_img; ?>" width="100px" height="100px"></td> 
                                                 <td><?php echo ucfirst($user->author_msg); ?></td>
                                                <td><?php echo date('d M Y',strtotime($user->msg_added_date)); ?></td>
                                               <td><?php if($user->status == 1){ echo '<span class="label label-primary">Active</span>'; }else{ echo '<span class="label label-info">Inactive</span>'; } ?></td>
                                                   <td>
                                                    <a href="<?php echo base_url(); ?>EditTestimonialDetails/<?php echo $user->id; ?>" title="Edit details"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
                                                    <a href="<?php echo base_url(); ?>DeleteTestmonial/<?php echo $user->id; ?>" title="Delete"><i class="fa fa-trash-o"></i></a>
