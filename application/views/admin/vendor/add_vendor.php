                ...
                <div class="panel-body"> <span style="color:red"><?php echo validation_errors(); ?> <?php echo $this->session->flashdata('Register_error'); ?></span>       
                    <form role="form" class="form-horizontal" action="" method="POST" enctype="multipart/form-data"  name="myForm" id="myForm">         
                        ...
                        <div class="form-group" id="category_section" style="<?php //echo $category_display;  ?>">     
                            ...
                            <div class="col-sm-7">             
                                <input type="text" name="vendor_firstname" id="banner_title" class="form-control" required="required">    
                            </div>
                        </div> 
                          <div class="form-group" id="category_section" style="<?php //echo $category_display;  ?>">     
                            <label class="control-label col-sm-4">Last Name<?php echo ASTRIK; ?></label>      
                            <div class="col-sm-7">             
                                <input type="text" name="vendor_lastname" id="banner_title" class="form-control" required="required">    
                            </div>
                        </div> 
                          <div class="form-group" id="category_section" style="<?php //echo $category_display;  ?>">     
                            <label class="control-label col-sm-4">Email<?php echo ASTRIK; ?></label>      
                            <div class="col-sm-7">             
                                <input type="email" name="vendor_email" id="banner_title" class="form-control" required="required">    
                            </div>
                        </div>
                          <div class="form-group" id="category_section" style="<?php //echo $category_display;  ?>">     
                            <label class="control-label col-sm-4">Experience In<?php echo ASTRIK; ?></label>      
                            <div class="col-sm-7">             
                                <input type="text" name="vendor_type" id="banner_title" class="form-control" required="required">    
                            </div>
                        </div> 
                          <div class="form-group" id="category_section" style="<?php //echo $category_display;  ?>">     
                            <label class="control-label col-sm-4">Experience Year<?php echo ASTRIK; ?></label>      
                            <div class="col-sm-7">             
                                <input type="text" name="vendor_experience" id="banner_title" class="form-control" required="required">    
                            </div>
                        </div> 
