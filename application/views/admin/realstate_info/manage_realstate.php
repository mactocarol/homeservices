        ...
        <div class="panel-body">
          <div class="adv-table" id="main-col">
            ...
            // print_r($realstate_info);exit;
              if($realstate_info !='no'){
                                         foreach ($realstate_info as $record){
                                         $id = $record->id;
                                         $catname = $record->cat_name;
                                         $fname = $record->fname;
                                         $lname = $record->lname;
                                         $email = $record->email;
                                         $cnumber = $record->mnumber;
                    ...
                    <td><?php echo strtoupper($fname); ?>&nbsp;<?php echo strtoupper($lname); ?></td>
                       ...
                       <td align="center">
                   <a href="<?php echo base_url();?>DeleteInfo/<?php echo $id; ?>"><i title="Delete" class="fa fa-trash-o" class="delete_row"></i></a></td>
                    </tr>
                     <?php 
                     $cnt++; 
              }  } else {
