    ...
    <div class="row">
        <div class="col-sm-12">
            <section class="panel">
              ...
              Promocode List
              <span class="tools pull-right"> <a href="<?php echo base_url();?>AddPromocode"><i class="fa fa-plus-circle"></i> Add</a></span>
                                  ...
                                  <tbody>
                                    ...
                                    if ($promocode != '') {
                                        foreach ($promocode as $user){
                                            ...
                                            <tr>
                                                <td><?php echo $cnt; ?></td>
                                                <td><?php echo ucfirst($user->promo_title); ?></td>
                                                <td><?php echo ucfirst($user->promo_for); ?></td>
                                                <td><?php echo ucfirst($user->max_no_uses); ?></td>
                                                <td><?php echo ucfirst($user->promo_discount_val); ?></td>
                                                <td><?php echo date('d M Y',strtotime($user->created_date)); ?></td>
                                                 <td><?php echo date('d M Y',strtotime($user->expiry_date)); ?></td>
                                                <td><?php if($user->status == 1){ echo '<span class="label label-primary">Active</span>'; }else{ echo '<span class="label label-info">Inactive</span>'; } ?></td>
                                                   <td>
                                                    <a href="<?php echo base_url(); ?>EditPromocodeDetails/<?php echo $user->id; ?>" title="Edit details"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
                                                    <a href="<?php echo base_url(); ?>DeletePromocode/<?php echo $user->id; ?>" title="Delete"><i class="fa fa-trash-o"></i></a>
