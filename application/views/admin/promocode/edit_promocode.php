    ...
    <div class="row">
        <div class="col-lg-12">
            <section class="panel">
                ...
                $title = $promocode_details->promo_title;
                $p_for = $promocode_details->promo_for;
                $user = $promocode_details->max_no_uses;
                $p_val = $promocode_details->promo_discount_val;
                $date = $promocode_details->created_date;
                $exp_date = $promocode_details->expiry_date;
                ...
                <div class="panel-body"> <span style="color:red"><?php echo validation_errors(); ?> <?php echo $this->session->flashdata('Register_error'); ?></span>
                    <form role="form" class="form-horizontal" action="" method="POST" enctype="multipart/form-data"  name="myForm" id="myForm">
                        ...
                        <div class="form-group" id="category_section" style="<?php //echo $category_display; ?>">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="promo_title" id="banner_title" value="<?php echo $title; ?>"class="form-control required">
                            </div>
                        </div>
...
<!--                          <div class="form-group" id="category_section" style="<?php //echo $category_display;  ?>">     
                         ...
                         <div class="form-group" id="category_section" style="<?php //echo $category_display; ?>">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="max_no_uses" id="banner_title" value="<?php echo $user; ?>"class="form-control required">
                            </div>
                        </div>
                         <div class="form-group" id="category_section" style="<?php //echo $category_display; ?>">
                            <label class="control-label col-sm-4">Discount<?php echo ASTRIK; ?></label>
                            <div class="col-sm-7">
                                <input type="text" name="promo_discount_val" id="banner_title" value="<?php echo $p_val; ?>"class="form-control required">
                            </div>
                        </div>
                           <div class="form-group" id="category_section" style="<?php //echo $category_display;  ?>">     
                            <label class="control-label col-sm-4">Active On<?php echo ASTRIK; ?></label>      
                            <div class="col-sm-7">             
                                <input type="text" name="created_date" id="datepicker" value="<?php echo $date; ?>" class="form-control" required="required">    
                            </div>
                        </div> 
                          <div class="form-group" id="category_section" style="<?php //echo $category_display;  ?>">     
                            <label class="control-label col-sm-4">Exprie On<?php echo ASTRIK; ?></label>      
                            <div class="col-sm-7">             
                                <input type="text" name="expiry_date" id="datepickers" value="<?php echo $exp_date; ?>" class="form-control" required="required">    
                            </div>
                        </div> 
                        <div class="form-group">
