               ...
               <!-- <div class="col-sm-3">
                 ...
                 <div class="col-sm-2">
                  ...
                  <div class="col-sm-2">
                   ...
                   <?php if(isset($get_php[0]->fixed_price) && $get_php[0]->fixed_price != ''){  ?>
                   <div class="col-sm-3">
                      <label class="control-label">&nbsp;</label>
                      <div class="form-group">
               ...
               <?php } } ?>
                ...
                $get_professionals = (empty($fetch_details->cat_attribute))? '' : $fetch_details->cat_attribute;
                  if(!empty($get_professionals)){
                    ...
                    $get_extra = (empty($fetch_details->extra))? '' : $fetch_details->extra;
                    if(!empty($get_extra)){
                    $get_extra_php = json_decode($get_extra);
                    }
                      ...
                      ?>
                              <div class='row'>
                               ...
                               <div class="col-sm-1">
                                ...
                                <?php if(isset($fetch_prohouprice->fixed_price) && $fetch_prohouprice->fixed_price != ''){  ?>
                                <div class="col-sm-2">
                                        <label class="control-label">Price</label>
                                        <div class="form-group">
                                            <input type='text' class='form-control' name="fixed_price[]" placeholder="Price" id='fixed_price_<?php echo $id;?>' value="<?php echo !empty($fetch_prohouprice->fixed_price)?$fetch_prohouprice->fixed_price:'';?>"/>
                                        </div>
                                </div> 
                                <?php } else { ?>
                                <div class="col-sm-2">
                                    ...
                                    <div class="form-group">
                                        <input type='text' class='form-control' name="weekly_price[]" id='weekly_price_<?php echo $id;?>' value="<?php echo !empty($fetch_prohouprice->weekly_price)?$fetch_prohouprice->weekly_price:'';?>"/>
                                    </div>
                                </div> 
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <div class="form-group">
                                        <input type='text' class='form-control' name="biweekly_price[]" id='biweekly_price_<?php echo $id;?>' value="<?php echo !empty($fetch_prohouprice->biweekly_price)?$fetch_prohouprice->biweekly_price:'';?>"/>
                                    </div>
                                </div> 
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <div class="form-group">
                                        <input type='text' class='form-control' name="monthly_price[]" id='monthly_price_<?php echo $id;?>' value="<?php echo !empty($fetch_prohouprice->monthly_price)?$fetch_prohouprice->monthly_price:'';?>"/>
                                    </div>
                                </div> 
                                <?php } ?>
                  ...
                  if(!empty($get_extra_php)){  ?>
                     <header class="panel-heading"> Extras</header><br/>
                      ...
                      <?php foreach ($get_extra_php as $row) {
                      ?>
                              ...
                              <div class="row" id="img_box_1">
                                    ...
                                    <div class="form-group" id="product_img_div">
                                      ...
                                      <input type='text' class="form-control" id="extra_1_<?php echo $id1;?>" name="extra[]" value="<?php echo !empty($row->extra)?$row->extra:'';?>"/>
                                      </div>
                                    </div>
                                    <div class="col-sm-4">
                                          <label class="control-label">Price</label>
                                          <div class="form-group">
                                              <input type='text' class='form-control' name="extra_price[]" id='price_1_<?php echo $id;?>' value="<?php echo !empty($row->extra_price)?$row->extra_price:'';?>"/>
                                          </div>
                                    </div>
                                    <div class='col-sm-4'>
                                      <label class='control-label'>&nbsp;</label>
                                      <div class='form-group'>
                                        <img src='<?php echo base_url();?>assets/images/bt_delete.png' style='cursor:pointer' title='Remove Image' class='remove_img_div'/>
                                      </div>
                                    </div>
                                  </div>
