    ...
    <div class="row">
        <div class="col-sm-12">
            <section class="panel">
              ...
              Template List
              <span class="tools pull-right"> <a href="<?php echo base_url();?>AddTemplate"><i class="fa fa-plus-circle"></i> Add Template</a></span>
                            ...
                            <table class="display table table-bordered table-striped" id="dynamic-table">
                                <thead>
                                  ...
                                  <tbody>
                                    ...
                                    $cnt = 1;
                                    if ($template != 'no') {
                                        foreach ($template as $user) {
                                            ?>
                                            <tr>
                                                <td><?php echo $cnt; ?></td>
                                                <td><?php echo ucfirst($user->title); ?></td>
                                                <td><?php echo ucfirst($user->content); ?></td>
                                               ...
                                               <td><?php if($user->status == 1){ echo '<span class="label label-primary">Active</span>'; }else{ echo '<span class="label label-info">Inactive</span>'; } ?></td>
                                                   <td>
                                                    <a href="<?php echo base_url(); ?>EditTemplateDetails/<?php echo $user->id; ?>" title="Edit details"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
                                                    <a href="<?php echo base_url(); ?>DeleteTemplate/<?php echo $user->id; ?>" title="Delete"><i class="fa fa-trash-o"></i></a>
