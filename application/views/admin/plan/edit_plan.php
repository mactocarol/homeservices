    ...
    <div class="row">   
        <div class="col-lg-12">    
            <section class="panel">       
                ...
                <div class="panel-body"> 
                    ...
                    <form role="form" class="form-horizontal" action="" method="POST" enctype="multipart/form-data"  name="myForm" id="myForm">         
                        ...
                        <div class="form-group" id="category_section">     
                            ...
                            <div class="col-sm-7">             
                                <input type="text" name="plan_title" id="plan_title" class="form-control" value="<?php echo (!empty($get_plan->plan_title)) ? $get_plan->plan_title : ''; ?>" required="required">    
                            </div>
                        </div> 
                                ...
                                <select name="plan_cat" id="plan_cat" class="form-control" onchange="get_cat(this.value);">
                                    ...
                                    <?php if($main_cat != 'no'){
                                            foreach ($main_cat as $category){
                                              $sel = (decode_category($get_plan->plan_cat) == $category->cat_name) ? 'selected="selected"' : '';
                                        ?>
                                    <option value="<?php echo encode_category($category->cat_name); ?>" <?php echo $sel; ?>><?php echo $category->cat_name; ?></option> 
                                    <?php } }?>
                                </select>
                            </div>            
                        </div> 
                        
                        <!--<header class="panel-heading">Frequency</header><br/>-->
                    <div class="row">
                    
                    <div class="col-sm-3">
                      <!--<label class="control-label">Weekly</label>-->
                      <div class="form-group">
                          <input type="hidden" class="form-control" name="weekly" readonly="readonly" value="Weekly"/>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                      ...
                      <div class="form-group">
                          <input type="hidden" class="form-control" name="weekly_price" value="1<?php //echo $get_plan->weekly_price ?>"/>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                      ...
                      <div class="form-group">
                          <input type="hidden" class="form-control" name="biweekly" readonly="readonly" value="Biweekly"/>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                      <!--<label class="control-label">Price</label>-->
                      <div class="form-group">
                          <input type="hidden" class="form-control" name="biweekly_price" value="1<?php //echo $get_plan->biweekly_price ?>"/>
                      </div>
                    </div>
                    
                    </div>
                       
                        <header class="panel-heading">Monthly Plan</header><br/>
                    <div class="row">
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-3">
                      ...
                      <div class="form-group">
                          <input type="number" class="form-control" name="one_price" value="<?php echo $get_plan->one_monthly_per ?>"/>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                      <label class="control-label">Percentage</label>
                      <div class="form-group">
                          <input type="number" class="form-control" name="three_price" value="<?php echo $get_plan->three_monthly_per ?>"/>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                      <label class="control-label">Percentage</label>
                      <div class="form-group">
                          <input type="number" class="form-control" name="six_price" value="<?php echo $get_plan->six_monthly_per ?>"/>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                      <label class="control-label">Percentage</label>
                      <div class="form-group">
                          <input type="number" class="form-control" name="twale_price" value="<?php echo $get_plan->yearly_per ?>"/>
                      </div>
                    </div>
                    </div>  
                ...
                <?php if($get_plan->extra != ''){
                  $extra = json_decode($get_plan->extra);
                ...
                <div class="form-group" id="product_img_div">
                  ...
                  value="<?php echo (!empty($value->extra)) ? $value->extra : ''?>" />
                  </div>
                </div>
                <div class="col-sm-4">
                      <label class="control-label">Price</label>
                      <div class="form-group">
                          <input type='text' class='form-control' name="extra_price[]" id='price_1' value="<?php echo (!empty($value->extra_price)) ? $value->extra_price : ''?>" />
                      </div>
                </div>  
              </div>
              <?php } } ?>
