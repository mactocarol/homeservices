                ...
                <div class="panel-body"> 
                    ...
                    <form role="form" class="form-horizontal" action="" method="POST" enctype="multipart/form-data"  name="myForm" id="myForm">         
                        ...
                        <div class="form-group">             
                            ...
                            <div class="col-sm-7">               
                                <select name="plan_cat" id="plan_cat" class="form-control" onchange="get_cat1(this.value);">
                                    <option value="">Select Category</option> 
                                    <?php if($main_cat != 'no'){
                                            foreach ($main_cat as $category){
                                        ?>
                                    <option value="<?php echo encode_category($category->cat_name); ?>"><?php echo $category->cat_name; ?></option> 
                                    <?php } }?>
                                </select>
                            </div>            
                        </div>
                    ...
                    <div class="col-sm-3">
                      ...
                      <div class="form-group">
                          <input type="hidden" class="form-control" name="weekly_price" value="1"/>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                      <!--<label class="control-label">Price</label>-->
                      <div class="form-group">
                          <input type="hidden" class="form-control" name="biweekly_price" value="1"/>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                      ...
                      <div class="form-group">
                          <input type="number" class="form-control" name="one_price"/>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                      <label class="control-label">Percentage</label>
                      <div class="form-group">
                          <input type="number" class="form-control" name="three_price"/>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                      <label class="control-label">Percentage</label>
                      <div class="form-group">
                          <input type="number" class="form-control" name="six_price"/>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                      <label class="control-label">Percentage</label>
                      <div class="form-group">
                          <input type="number" class="form-control" name="twale_price"/>
                      </div>
                    </div>
                    </div>  
